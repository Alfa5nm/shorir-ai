          ...
          <div className="form-grid">
            ...
            <label>
              ...
              <input
                ...
                onChange={(event) => {
                  ...
                  setForm({ ...form, age: val === "" ? undefined : parseInt(val, 10) });
                }}
                placeholder="Optional"
              />
            </label>
            <label>
              ...
              <select
                ...
                onChange={(event) => {
                  const val = event.target.value;
                  setForm({ ...form, gender: val === "" ? undefined : val as "male" | "female" | "other" });
                }}
              >
            ...
            <label>
              ...
              <input
                ...
                onChange={(event) => {
                  const val = event.target.value;
                  setForm({ ...form, height: val === "" ? undefined : parseFloat(val) });
                }}
                placeholder="Optional"
              />
            </label>
            <label>
              ...
              <input
                ...
                onChange={(event) => {
                  const val = event.target.value;
                  setForm({ ...form, weight: val === "" ? undefined : parseFloat(val) });
                }}
                placeholder="Optional"
              />
            </label>
            <label>
              ...
              <input
                ...
                onChange={(event) => {
                  const val = event.target.value;
                  setForm({ ...form, targetWeight: val === "" ? undefined : parseFloat(val) });
                }}
                placeholder="Optional"
              />
            </label>
